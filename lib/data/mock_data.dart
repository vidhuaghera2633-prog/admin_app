...
class MockData {
  static List<Complaint> complaints = [
    Complaint(
      ...
      district: 'Mumbai', address: 'GPS: 19.1136, 72.8697 | Flat 12B, Andheri West, Mumbai',
    ...
    Complaint(
      ...
      district: 'Delhi', address: 'GPS: 28.5685, 77.2410 | House 45, Lajpat Nagar, Delhi',
    ...
    Complaint(
      ...
      district: 'Ahmedabad', address: 'GPS: 23.0300, 72.5133 | B-22, Satellite, Ahmedabad',
    ...
    Complaint(
      ...
      district: 'Bengaluru', address: 'GPS: 12.9716, 77.5946 | Flat 8, Indiranagar, Bengaluru',
    ...
    Complaint(
      ...
      district: 'Chennai', address: 'GPS: 13.0067, 80.2700 | Villa 23, Besant Nagar, Chennai',
    ...
    Complaint(
      ...
      district: 'Pune', address: 'GPS: 18.5074, 73.8077 | House 7, Kothrud, Pune',
